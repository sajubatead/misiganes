...
//POST type
function um_apartments_manager_post_type() {
$singular = 'Apartments Listing';
$plural = 'Apartments Listings';
$slug = str_replace( ' ', '_', strtolower( $singular ) );
  ...
  $labels = array(
    ...
    'menu_name' => 'UM Arendused',
    'all_items'  => 'Korterite Nimekiri'
  );
...
add_action('init', 'um_apartments_manager_post_type');


// Rename apartment_listing submenu
function tw_remove_menu_pages() {
	// remove testimonials menu section
	// remove_menu_page( 'edit.php?post_type=testimonials-widget' );

	remove_submenu_page( 'edit.php?post_type=apartments_listing', 'apartments_listing' );
}
